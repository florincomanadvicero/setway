...
<?php sports_store_get_header_search_form($cmsmasters_option); ?>

<!--  Start Page  -->
<div id="page" class="<?php sports_store_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<header id="header"<?php 
	if ($cmsmasters_option['sports-store' . '_header_styles'] == 'fullwidth') {
...
<div id="middle">
<?php 
sports_store_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = sports_store_theme_page_layout_scheme();
