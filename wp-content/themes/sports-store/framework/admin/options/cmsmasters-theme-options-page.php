...
if (!function_exists('sports_store_get_custom_page_meta_fields')) {
function sports_store_get_custom_page_meta_fields() {
	$cmsmasters_option = sports_store_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['sports-store' . '_layout']) && $cmsmasters_option['sports-store' . '_layout'] !== '') ? $cmsmasters_option['sports-store' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['sports-store' . '_header_overlaps']) && $cmsmasters_option['sports-store' . '_header_overlaps'] !== '') ? (($cmsmasters_option['sports-store' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'sports-store'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'sports-store'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'sports-store'), 
