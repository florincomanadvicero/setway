...
if (!function_exists('sports_store_get_custom_profile_meta_fields')) {
function sports_store_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['sports-store' . '_profile_post_title']) && $cmsmasters_option['sports-store' . '_profile_post_title'] !== '') ? (($cmsmasters_option['sports-store' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['sports-store' . '_profile_post_details_title']) && $cmsmasters_option['sports-store' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['sports-store' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['sports-store' . '_profile_post_share_box']) && $cmsmasters_option['sports-store' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['sports-store' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'sports-store'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'sports-store'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'sports-store'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'sports-store'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'sports-store'), 
			'desc'	=> '', 
