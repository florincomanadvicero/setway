...
if (!function_exists('sports_store_get_custom_project_meta_fields')) {
function sports_store_get_custom_project_meta_fields() {
	...
	$cmsmasters_global_portfolio_project_title = (isset($cmsmasters_option['sports-store' . '_portfolio_project_title']) && $cmsmasters_option['sports-store' . '_portfolio_project_title'] !== '') ? (($cmsmasters_option['sports-store' . '_portfolio_project_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_details_title = (isset($cmsmasters_option['sports-store' . '_portfolio_project_details_title']) && $cmsmasters_option['sports-store' . '_portfolio_project_details_title'] !== '') ? $cmsmasters_option['sports-store' . '_portfolio_project_details_title'] : '';
	
	$cmsmasters_global_portfolio_project_share_box = (isset($cmsmasters_option['sports-store' . '_portfolio_project_share_box']) && $cmsmasters_option['sports-store' . '_portfolio_project_share_box'] !== '') ? (($cmsmasters_option['sports-store' . '_portfolio_project_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_author_box = (isset($cmsmasters_option['sports-store' . '_portfolio_project_author_box']) && $cmsmasters_option['sports-store' . '_portfolio_project_author_box'] !== '') ? (($cmsmasters_option['sports-store' . '_portfolio_project_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_more_projects_box = (isset($cmsmasters_option['sports-store' . '_portfolio_more_projects_box'])) ? $cmsmasters_option['sports-store' . '_portfolio_more_projects_box'] : 'related';
	
	$cmsmasters_proportion = sports_store_project_puzzle_proportion();
	...
	$tabs_array['cmsmasters_project'] = array( 
		'label' => esc_html__('Project', 'sports-store'), 
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Images', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Project', 'sports-store'), 
		...
		array( 
			'label'	=> esc_html__('Number of Columns', 'sports-store'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => esc_html__('Three', 'sports-store'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => esc_html__('Two', 'sports-store'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => esc_html__('One', 'sports-store'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> esc_html__('Project Title', 'sports-store'), 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image Size', 'sports-store'), 
			'desc'	=> esc_html__('Recommended Project Puzzle Image dimensions, or other size, with the same ratio:', 'sports-store') . '</br>', 
			...
			'options' => array( 
				'one_x_one' => array( 
					...
					'size' => 'No Gap or 1px Gap - 480 x ' . ((int) (480 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 480 x ' . ((int) (480 * $cmsmasters_proportion - sports_store_project_puzzle_large_gar('one_x_one'))), 
					'label' => '1 x 1', 
					'value'	=> 'one_x_one' 
				), 
				'one_x_two' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/one_x_two.jpg', 
					'size' => 'No Gap or 1px Gap - 480 x ' . ((int) (960 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 480 x ' . sports_store_project_puzzle_large_gar('one_x_two'), 
					'label' => '1 x 2', 
					'value'	=> 'one_x_two' 
				), 
				'one_x_three' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/one_x_three.jpg', 
					'size' => 'No Gap or 1px Gap - 480 x ' . ((int) (1440 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 480 x ' . sports_store_project_puzzle_large_gar('one_x_three'), 
					'label' => '1 x 3', 
					'value'	=> 'one_x_three' 
				), 
				'two_x_one' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/two_x_one.jpg', 
					'size' => 'No Gap or 1px Gap - 960 x ' . ((int) (480 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 960 x ' . sports_store_project_puzzle_large_gar('two_x_one'), 
					'label' => '2 x 1', 
					'value'	=> 'two_x_one' 
				), 
				'two_x_two' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/two_x_two.jpg', 
					'size' => 'No Gap or 1px Gap - 960 x ' . ((int) (960 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 960 x ' . ((int) (960 * $cmsmasters_proportion - sports_store_project_puzzle_large_gar('two_x_two'))), 
					'label' => '2 x 2', 
					'value'	=> 'two_x_two' 
				), 
				'two_x_three' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/two_x_three.jpg', 
					'size' => 'No Gap or 1px Gap - 960 x ' . ((int) (1440 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 960 x ' . sports_store_project_puzzle_large_gar('two_x_three'), 
					'label' => '2 x 3', 
					'value'	=> 'two_x_three' 
				), 
				'three_x_one' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/three_x_one.jpg', 
					'size' => 'No Gap or 1px Gap - 1440 x ' . ((int) (480 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 1440 x ' . sports_store_project_puzzle_large_gar('three_x_one'), 
					'label' => '3 x 1', 
					'value'	=> 'three_x_one' 
				), 
				'three_x_two' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/three_x_two.jpg', 
					'size' => 'No Gap or 1px Gap - 1440 x ' . ((int) (960 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 1440 x ' . sports_store_project_puzzle_large_gar('three_x_two'), 
					'label' => '3 x 2', 
					'value'	=> 'three_x_two' 
				), 
				'three_x_three' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/three_x_three.jpg', 
					'size' => 'No Gap or 1px Gap - 1440 x ' . ((int) (1440 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 1440 x ' . ((int) (1440 * $cmsmasters_proportion - sports_store_project_puzzle_large_gar('three_x_three'))), 
					'label' => '3 x 3', 
					'value'	=> 'three_x_three' 
				), 
				'four_x_four' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/four_x_four.jpg', 
					'size' => 'No Gap or 1px Gap - 1920 x ' . ((int) (1920 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 1920 x ' . ((int) (1920 * $cmsmasters_proportion - sports_store_project_puzzle_large_gar('four_x_four'))), 
					'label' => '4 x 4', 
					'value'	=> 'four_x_four' 
				) 
			) 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image (1px or No Gap)', 'sports-store'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects 1px or no gap', 'sports-store'), 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image (Large Gap)', 'sports-store'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects large gap', 'sports-store'), 
		...
		array( 
			'label'	=> esc_html__('Project Details Title', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Info', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__("Project Link Text", 'sports-store'), 
			'desc'	=> '', 
			'id'	=> $cmsmasters_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('View Project', 'sports-store') 
		), 
		array( 
			'label'	=> esc_html__("Project Link URL", 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> esc_html__('Redirect to project link URL instead of opening project page', 'sports-store'), 
		...
		array( 
			'label'	=> esc_html__("Project Link Target", 'sports-store'), 
			'desc'	=> esc_html__('Open link in a new tab', 'sports-store'), 
		...
		array( 
			'label'	=> esc_html__('Project Features 1 Title', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 1', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2 Title', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3 Title', 'sports-store'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3', 'sports-store'), 
			'desc'	=> '', 
...
if (!function_exists('sports_store_project_puzzle_large_gar')) {

function sports_store_project_puzzle_large_gar($image_size = 'default') {
	$padding = '';
	
	$project_puzzle_large_gar_parameter = sports_store_project_puzzle_large_gar_parameters();
