...
function sports_store_yith_woocommerce_wishlist_colors($custom_css) {
...
/***************** Start {$title} Yith WooCommerce Wishlist Colors Scheme Rules ******************/
	...
	{$rule}.woocommerce a.selectBox {
		border-color:" . $cmsmasters_option['sports-store' . '_' . $scheme . '_border'] . " !important;
	}
...
add_filter('sports_store_theme_colors_secondary_filter', 'sports_store_yith_woocommerce_wishlist_colors');
