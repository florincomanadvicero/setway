...
function sports_store_yith_woocommerce_wishlist_fonts($custom_css) {
...
/***************** Start Yith WooCommerce Wishlist Font Styles ******************/
	...
	#yith-wcwl-form.woocommerce table.wishlist_table td.product-price del {
		font-size:" . ((int) $cmsmasters_option['sports-store' . '_content_font_font_size'] - 1) . "px;
		line-height:" . ((int) $cmsmasters_option['sports-store' . '_content_font_line_height'] - 4) . "px;
	}
	/* Finish Content Font */
	...
	#yith-wcwl-form.woocommerce table.wishlist_table td.product-name a.yith-wcqv-button {
		height:" . ((int) $cmsmasters_option['sports-store' . '_h5_font_line_height'] - 2) . "px;
	}
	/* Finish H5 Font */
...
add_filter('sports_store_theme_fonts_filter', 'sports_store_yith_woocommerce_wishlist_fonts');
