...
function sports_store_yith_woocommerce_quick_view_fonts($custom_css) {
...
/***************** Start Yith WooCommerce Quick View Font Styles ******************/
	...
	#yith-quick-view-modal .single-product .price del {
		font-size:" . ((int) $cmsmasters_option['sports-store' . '_h3_font_font_size'] - 6) . "px;
	}
	/* Finish H3 Font */
	...
	.yith-quick-view.scale-in .single-product div.summary .price,
	.yith-quick-view.yith-inline .single-product div.summary .price {
		font-size:" . ((int) $cmsmasters_option['sports-store' . '_h6_font_font_size'] + 7) . "px;
		line-height:" . ((int) $cmsmasters_option['sports-store' . '_h6_font_line_height'] + 8) . "px;
	}
	...
	.yith-quick-view.yith-inline .single-product div.summary .price del {
		font-size:" . ((int) $cmsmasters_option['sports-store' . '_h6_font_font_size'] + 1) . "px;
		line-height:" . ((int) $cmsmasters_option['sports-store' . '_h6_font_line_height'] + 5) . "px;
	}
...
add_filter('sports_store_theme_fonts_filter', 'sports_store_yith_woocommerce_quick_view_fonts');
