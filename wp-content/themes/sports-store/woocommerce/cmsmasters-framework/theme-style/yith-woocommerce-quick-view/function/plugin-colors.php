...
function sports_store_yith_woocommerce_quick_view_colors($custom_css) {
...
/***************** Start {$title} Yith WooCommerce Quick View Colors Scheme Rules ******************/
	...
	{$rule}html .yith-quick-view.slide-in .yith-wcqv-head .yith-quick-view-close:hover:after, 
	{$rule}html .yith-quick-view.fade-in .yith-wcqv-head .yith-quick-view-close:hover:after, 
	{$rule}html .yith-quick-view.scale-up .yith-wcqv-head .yith-quick-view-close:hover:after,
	{$rule}html .yith-quick-view.slide-in .yith-wcqv-head .yith-quick-view-close:hover:before, 
	{$rule}html .yith-quick-view.fade-in .yith-wcqv-head .yith-quick-view-close:hover:before, 
	{$rule}html .yith-quick-view.scale-up .yith-wcqv-head .yith-quick-view-close:hover:before,
	...
	{$rule}.yith-quick-view.scale-in .single-product .yith-wcqv-view-details {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['sports-store' . '_' . $scheme . '_heading']) . "
	}
	...
	{$rule}li.product .cmsmasters_product .yith-wcqv-button.inside-thumb .blockUI.blockOverlay {
		background-color:" . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " !important;
	}
...
add_filter('sports_store_theme_colors_secondary_filter', 'sports_store_yith_woocommerce_quick_view_colors');
