...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'sports-store');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'sports-store');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'sports-store');
			...
			<div class=\"cmsmasters_post_filter cmsmasters_items_filter\">
				...
				<div class=\"cmsmasters_post_filter_block cmsmasters_items_filter_block\">
					...
					<ul class=\"cmsmasters_post_filter_list cmsmasters_items_filter_list\">
						<li class=\"current\">
							<a class=\"button\" data-filter=\"article.post\"  title=\"" . esc_attr($filter_cats_text) . "\" href=\"javascript:void(0);\">
