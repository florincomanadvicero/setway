...
if ($query->have_posts()) : 
	...
	$out .= "<div class=\"cmsmasters_posts_slider cmsmasters_posts_slider_" . esc_attr($post_type) . 
			...
			while ($query->have_posts()) : $query->the_post();
				...
				$out .= '<div class="cmsmasters_owl_slider_item">';
					...
					if ($post_type == 'post') {
						...
						$out .= cmsmasters_composer_ob_load_template('theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/post-type/posts-slider/slider-project.php', $this->posts_slider_atts);
					} else {
						$out .= cmsmasters_composer_ob_load_template('theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/post-type/posts-slider/slider-product.php', $this->posts_slider_atts);
					}
