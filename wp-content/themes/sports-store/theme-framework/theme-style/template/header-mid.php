...
echo '<div class="header_mid" data-height="' . esc_attr($cmsmasters_option['sports-store' . '_header_mid_height']) . '">' . 
	'<div class="header_mid_outer">' . 
		'<div class="header_mid_inner">';
			...
			if (
				...
				if (
					$cmsmasters_option['sports-store' . '_header_add_cont'] == 'cust_html' && 
					$cmsmasters_option['sports-store' . '_header_add_cont_cust_html'] !== ''
				) {
				echo '<div class="slogan_wrap">' . 
					'<div class="slogan_wrap_inner">' . 
						'<div class="slogan_wrap_text">' . 
							stripslashes($cmsmasters_option['sports-store' . '_header_add_cont_cust_html']) . 
						'</div>' . 
					'</div>' . 
				'</div>';
				} elseif (
					$cmsmasters_option['sports-store' . '_header_add_cont'] == 'social' && 
			...
			if ($cmsmasters_option['sports-store' . '_header_styles'] != 'c_nav') {
				...
				if (CMSMASTERS_WCWL) {
					echo '<div class="cmsmasters_wishlist_wrap">';
					
						sports_store_shop_wishlist_count();
