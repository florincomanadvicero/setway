...
function sports_store_register_theme_js_scripts() {
	...
	wp_localize_script('sports-store-theme-script', 'cmsmasters_theme_script', $cmsmasters_localize_array);
}

add_action('wp_enqueue_scripts', 'sports_store_register_theme_js_scripts');



/* Register Theme Navigations */
register_nav_menus(array( 
    'primary' => 	esc_html__('Primary Navigation', 'sports-store'), 
    'footer' => 	esc_html__('Footer Navigation', 'sports-store'), 
	'top_line' => 	esc_html__('Top Line Navigation', 'sports-store') 
));
...
function sports_store_fallback_menu($args) {
	$cmsmasters_option = sports_store_get_global_options();
	...
	echo '<div class="navigation_wrap">' . "\n" . 
		'<ul id="navigation" class="' . 
			'navigation ' . 
			($cmsmasters_option['sports-store' . '_header_styles'] == 'default' ? 'mid_nav' : 'bot_nav') . 
		'">' . "\n";
...
function sports_store_single_project_layout($cmsmasters_layout) {
	if (
		is_singular('project') || 
		is_singular('profile') 
	) {
...
add_filter('cmsmasters_theme_page_layout_filter', 'sports_store_single_project_layout');



/* Search Form */
function sports_store_search_form($form) {
	$form = "<div class=\"search_bar_wrap\">
		<form method=\"get\" action=\"" . esc_url(home_url('/')) . "\">
			<p class=\"search_field\">
				<input name=\"s\" placeholder=\"" . esc_attr__('Search...', 'sports-store') . "\" value=\"\" type=\"search\" />
			</p>
...
add_filter('get_search_form', 'sports_store_search_form');
