...
function sports_store_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_mailpoet_form .mailpoet_text,
	{$rule}.cmsmasters_mailpoet_form .wysija-input {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['sports-store' . '_' . $scheme . '_color']) . ", 0.08) !important;
	}
	...
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_inner a:hover,
	...
	{$rule}.cmsmasters_project_puzzle .project_outer:hover .project_inner {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['sports-store' . '_' . $scheme . '_link']) . ", 0.7);
	}
	...
	{$rule}textarea:focus,
	{$rule}select:focus {
		-webkit-box-shadow:inset 0 0 0 1px " . $cmsmasters_option['sports-store' . '_' . $scheme . '_link'] . ";
		box-shadow:inset 0 0 0 1px " . $cmsmasters_option['sports-store' . '_' . $scheme . '_link'] . ";
	}
	...
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_inner a,
	...
	{$rule}.cmsmasters_featured_block.cmsmasters_featured_block_hover:after,  
	...
	{$rule}.cmsmasters_tabs .cmsmasters_tabs_list_item:after,
	...
	{$rule}.cmsmasters_single_slider .owl-pagination .owl-page:hover,
	{$rule}.cmsmasters_single_slider .owl-pagination .owl-page.active,
	...
	{$rule}.cmsmasters_header_search_form {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['sports-store' . '_' . $scheme . '_heading']) . ", 0.95);
	}
	...
	{$rule}.cmsmasters_profile .cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['sports-store' . '_' . $scheme . '_heading']) . ", 0.8);
	}
	
	{$rule}.post.cmsmasters_post_puzzle .preloader:after {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['sports-store' . '_' . $scheme . '_heading']) . ", 0.6);
	}
	...
	{$rule}.post.cmsmasters_post_puzzle .puzzle_post_content_wrapper:before {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['sports-store' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.cmsmasters_single_slider .owl-pagination .owl-page,
	...
	" . (($scheme == 'default') ? "#slide_top," : '') . "
	{$rule}.post_nav > span .cmsmasters_prev_arrow,
	{$rule}.post_nav > span .cmsmasters_next_arrow,
	{$rule}.headline_outer,
	{$rule}.sidebar,
	{$rule}.widget_nav_menu ul li a,
	...
	{$rule}.post.cmsmasters_post_puzzle .puzzle_post_content_wrapper {
		-webkit-box-shadow:inset 0 0 0 1px " . $cmsmasters_option['sports-store' . '_' . $scheme . '_border'] . ";
		box-shadow:inset 0 0 0 1px " . $cmsmasters_option['sports-store' . '_' . $scheme . '_border'] . ";
	}
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['sports-store' . '_' . $scheme . '_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['sports-store' . '_' . $scheme . '_bg']) . ";
	}
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['sports-store' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
/***************** Start {$title} Button Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_button.cmsmasters_but_icon_divider:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['sports-store' . '_' . $scheme . '_bg']) . "
	}
...
";
	...
	return apply_filters('sports_store_theme_colors_primary_filter', $custom_css);
}
