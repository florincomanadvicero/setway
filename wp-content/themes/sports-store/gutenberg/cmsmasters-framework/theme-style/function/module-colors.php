...
function sports_store_gutenberg_module_colors($custom_css = '', $is_editor = false) {
...
/***************** Start Gutenberg Module Custom Colors Scheme Rules ******************/
	...
	{$editor} .wp-block-quote.is-large:before, 
	{$editor} .wp-block-quote.is-style-large:before,
	.editor-styles-wrapper .wp-block-freeform blockquote:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['sports-store' . '_default_hover']) . "
	}
	
	{$editor} .wp-block-quote,
	.editor-styles-wrapper .wp-block-freeform blockquote,
	.editor-styles-wrapper .wp-block-freeform blockquote p {
		" . cmsmasters_color_css('color', $cmsmasters_option['sports-store' . '_default_heading']) . "
	}
	...
	.editor-styles-wrapper .wp-block-freeform table tbody tr td {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['sports-store' . '_default_border']) . "
	}
	
	{$editor} .wp-block-table.is-style-stripes tr:nth-child(odd) td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['sports-store' . '_default_alternate']) . "
	}
	...
	{$editor} .wp-block-freeform.mce-content-body > table thead td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['sports-store' . '_default_link']) . "
		" . cmsmasters_color_css('border-color', $cmsmasters_option['sports-store' . '_default_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['sports-store' . '_default_bg']) . "
	}
	/* Finish Table Colors */
	
	.post-type-post .editor-post-title__block .editor-post-title__input {
		" . cmsmasters_color_css('color', $cmsmasters_option['sports-store' . '_default_link']) . "
	}
...
/***************** Start Gutenberg Module General Colors Scheme Rules ******************/
	...
	{$editor} .wp-block-search .wp-block-search__button	{
		" . cmsmasters_color_css('color', $cmsmasters_option['sports-store' . '_default_color']) . "
	}
	...
	.editor-styles-wrapper .wp-block select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['sports-store' . '_default_hover']) . "
	}
	...
	{$editor} .wp-block-pullquote.is-style-solid-color {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['sports-store' . '_default_heading']) . "
	}
	
	{$editor} .wp-block-pullquote {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['sports-store' . '_default_heading']) . "
	}
	...
	body .editor-styles-wrapper,
	{$editor} .wp-block-search .wp-block-search__input {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['sports-store' . '_default_bg']) . "
	}
	...
	{$editor} .wp-block-separator.is-style-dots:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['sports-store' . '_default_border']) . "
	}
	
	{$editor} .wp-block-separator:not(.is-style-dots):before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['sports-store' . '_default_border']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['sports-store' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['sports-store' . '_default_hover']) . "
	}
...
";
	$custom_css .= sports_store_gutenberg_editor_color_palettes_styles( true );
	
	return $custom_css;
}

add_filter('sports_store_theme_colors_secondary_filter', 'sports_store_gutenberg_module_colors');
